...
/** Result of WorkflowEngine.handleToolResult() */
export interface HandleToolResultOutput {
  success: boolean;
  newState?: string;
  stateChanged: boolean; /** Present when the tool has requiresReadAfterWrite and the read succeeded */
  readResult?: unknown;
